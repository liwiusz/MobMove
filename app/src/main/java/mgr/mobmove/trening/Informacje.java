...
public class Informacje extends Fragment implements LocationListener, SensorEventListener{
    ...
    TextView czas;
    public  long time =0;
   public static TextView speed,timeM;
    TextView MapaX,MapaY,DystansMap;
   public static  float currentDustance  ;
    ...
    public static float nCurrentSpeed=0;
    public static double mapaX=0;
    public static double mapaY=0;
    private static double mapaXold=0;
    private static double mapaYold=0;
    public static float krok=0;
    private static long elapsedMillis=0;
    private String rodzajAktywnosci;
    private String cel;
    private String inne;
    public  static boolean trwaTrening = false ;
...
Runnable updateTimerThread = new Runnable() {
    ...
    public void run() {
        ...
        //
        d.setMacierzObrotu(Sensory.macierzObrotu);
        //
       ...
       saveTrening.setOnClickListener(new View.OnClickListener() {
        ...
        chronometer.setOnChronometerTickListener(new Chronometer.OnChronometerTickListener() {
            ...
            public void onChronometerTick(Chronometer chronometer) {
               elapsedMillis = (SystemClock.elapsedRealtime() - chronometer.getBase())/100000;
            }
        });
